    ...
    try {        
        ...
        while (!$allResourceGroupsDeleted) {
            ...
            foreach($ModuleConfigurationName in $allModules) {
                ...
                Write-Host "Deleting Module: $ModuleConfigurationName in loop: $loop" -ForegroundColor Yellow
                $moduleConfiguration = `
                    Get-ModuleConfiguration `
                        -ArchetypeInstanceJson $archetypeInstanceJson `
                        -ModuleConfigurationName $moduleConfigurationName `
                ...
                elseif ($null -eq $moduleConfiguration.Subscription -or 
                        $moduleConfiguration.Subscription -eq $archetypeInstanceJson.Parameters.Subscription) {
